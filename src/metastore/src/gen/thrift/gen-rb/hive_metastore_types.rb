...
module FOFailReason
  ...
  NOTEXIST = 11
  SAFEMODE = 12
  VALUE_MAP = {1 => "INVALID_NODE", 2 => "INVALID_TABLE", 3 => "INVALID_FILE", 10 => "NOSPACE", 11 => "NOTEXIST", 12 => "SAFEMODE"}
  VALID_VALUES = Set.new([INVALID_NODE, INVALID_TABLE, INVALID_FILE, NOSPACE, NOTEXIST, SAFEMODE]).freeze
end
