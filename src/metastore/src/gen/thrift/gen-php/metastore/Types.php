      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::SET) {
            ...
            {
              $elem81 = null;
              $elem81 = new \metastore\Node();
              $xfer += $elem81->read($input);
              if (is_scalar($elem81)) {
                $this->nodes[$elem81] = true;
              } else {
                $this->nodes []= $elem81;
              }
            }
  ...
  public function write($output) {
    ...
    if ($this->nodes !== null) {
      ...
      $xfer += $output->writeFieldBegin('nodes', TType::SET, 4);
      {
        ...
        {
          foreach ($this->nodes as $iter82 => $iter83)
          {
            if (is_scalar($iter83)) {
  ...
  public function write($output) {
    ...
    if ($this->parameters !== null) {
      ...
      $xfer += $output->writeFieldBegin('parameters', TType::MAP, 4);
      {
        ...
        {
          foreach ($this->parameters as $kiter91 => $viter92)
          {
  ...
  public function write($output) {
    ...
    if ($this->parameters !== null) {
      ...
      $xfer += $output->writeFieldBegin('parameters', TType::MAP, 3);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->parameters));
        {
          foreach ($this->parameters as $kiter100 => $viter101)
          {
  ...
  public function write($output) {
    ...
    if ($this->skewedColNames !== null) {
      ...
      $xfer += $output->writeFieldBegin('skewedColNames', TType::LST, 1);
      {
        ...
        {
          foreach ($this->skewedColNames as $iter133)
          {
    ...
    if ($this->skewedColValues !== null) {
      ...
      $xfer += $output->writeFieldBegin('skewedColValues', TType::LST, 2);
      {
        ...
        {
          foreach ($this->skewedColValues as $iter134)
          {
            {
              $output->writeListBegin(TType::STRING, count($iter134));
              {
                foreach ($iter134 as $iter135)
                {
    ...
    if ($this->skewedColValueLocationMaps !== null) {
      ...
      $xfer += $output->writeFieldBegin('skewedColValueLocationMaps', TType::MAP, 3);
      {
        ...
        {
          foreach ($this->skewedColValueLocationMaps as $kiter136 => $viter137)
          {
            {
              $output->writeListBegin(TType::STRING, count($kiter136));
              {
                foreach ($kiter136 as $iter138)
                {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem144 = null;
              $elem144 = new \metastore\FieldSchema();
        ...
        case 9:
          if ($ftype == TType::LST) {
            ...
            {
              $elem156 = null;
              $elem156 = new \metastore\Order();
              $xfer += $elem156->read($input);
              $this->sortCols []= $elem156;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->bucketCols !== null) {
      ...
      $xfer += $output->writeFieldBegin('bucketCols', TType::LST, 8);
      {
        ...
        {
          foreach ($this->bucketCols as $iter165)
          {
    ...
    if ($this->sortCols !== null) {
      ...
      $xfer += $output->writeFieldBegin('sortCols', TType::LST, 9);
      {
        ...
        {
          foreach ($this->sortCols as $iter166)
          {
    ...
    if ($this->parameters !== null) {
      ...
      $xfer += $output->writeFieldBegin('parameters', TType::MAP, 10);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->parameters));
        {
          foreach ($this->parameters as $kiter167 => $viter168)
          {
  ...
  public function write($output) {
    ...
    if ($this->values !== null) {
      ...
      $xfer += $output->writeFieldBegin('values', TType::LST, 1);
      {
        ...
        {
          foreach ($this->values as $iter188)
          {
    ...
    if ($this->files !== null) {
      ...
      $xfer += $output->writeFieldBegin('files', TType::LST, 8);
      {
        ...
        {
          foreach ($this->files as $iter191)
          {
            $xfer += $output->writeI64($iter191);
          }
        }
        $output->writeListEnd();
      }
      ...
      switch ($fid)
      {
        ...
        case 10:
          if ($ftype == TType::LST) {
            ...
            {
              $elem216 = null;
              $elem216 = new \metastore\Subpartition();
              $xfer += $elem216->read($input);
              $this->subpartitions []= $elem216;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->values !== null) {
      ...
      $xfer += $output->writeFieldBegin('values', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRING, count($this->values));
        {
          foreach ($this->values as $iter217)
          {
    ...
    if ($this->parameters !== null) {
      ...
      $xfer += $output->writeFieldBegin('parameters', TType::MAP, 7);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->parameters));
        {
          foreach ($this->parameters as $kiter218 => $viter219)
          {
    ...
    if ($this->files !== null) {
      ...
      $xfer += $output->writeFieldBegin('files', TType::LST, 8);
      {
        $output->writeListBegin(TType::I64, count($this->files));
        {
          foreach ($this->files as $iter220)
          {
            $xfer += $output->writeI64($iter220);
          }
        }
        $output->writeListEnd();
      }
    ...
    if ($this->subpartitions !== null) {
      ...
      $xfer += $output->writeFieldBegin('subpartitions', TType::LST, 10);
      {
        ...
        {
          foreach ($this->subpartitions as $iter221)
          {
      ...
      switch ($fid)
      {
        ...
        case 9:
          if ($ftype == TType::LST) {
            ...
            {
              $elem236 = null;
              $elem236 = new \metastore\FieldSchema();
              $xfer += $elem236->read($input);
              $this->partitionKeys []= $elem236;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 14:
          if ($ftype == TType::LST) {
            ...
            {
              $elem249 = null;
              $elem249 = new \metastore\NodeGroup();
              $xfer += $elem249->read($input);
              $this->nodeGroups []= $elem249;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 16:
          if ($ftype == TType::LST) {
            ...
            {
              $elem255 = null;
              $elem255 = new \metastore\Partition();
              $xfer += $elem255->read($input);
              $this->partitions []= $elem255;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 17:
          if ($ftype == TType::LST) {
            ...
            {
              $elem261 = null;
              $elem261 = new \metastore\FieldSchema();
              $xfer += $elem261->read($input);
              $this->fileSplitKeys []= $elem261;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->partitionKeys !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionKeys', TType::LST, 9);
      {
        ...
        {
          foreach ($this->partitionKeys as $iter262)
          {
    ...
    if ($this->parameters !== null) {
      ...
      $xfer += $output->writeFieldBegin('parameters', TType::MAP, 10);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->parameters));
        {
          foreach ($this->parameters as $kiter263 => $viter264)
          {
    ...
    if ($this->nodeGroups !== null) {
      ...
      $xfer += $output->writeFieldBegin('nodeGroups', TType::LST, 14);
      {
        ...
        {
          foreach ($this->nodeGroups as $iter265)
          {
    ...
    if ($this->partitions !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitions', TType::LST, 16);
      {
        ...
        {
          foreach ($this->partitions as $iter266)
          {
    ...
    if ($this->fileSplitKeys !== null) {
      ...
      $xfer += $output->writeFieldBegin('fileSplitKeys', TType::LST, 17);
      {
        ...
        {
          foreach ($this->fileSplitKeys as $iter267)
          {
      ...
      switch ($fid)
      {
        ...
        case 9:
          if ($ftype == TType::LST) {
            ...
            {
              $elem273 = null;
              $elem273 = new \metastore\SFileLocation();
              $xfer += $elem273->read($input);
              $this->locations []= $elem273;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->locations !== null) {
      ...
      $xfer += $output->writeFieldBegin('locations', TType::LST, 9);
      {
        ...
        {
          foreach ($this->locations as $iter280)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem296 = null;
              $elem296 = new \metastore\ColumnStatisticsObj();
              $xfer += $elem296->read($input);
              $this->statsObj []= $elem296;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->statsObj !== null) {
      ...
      $xfer += $output->writeFieldBegin('statsObj', TType::LST, 2);
      {
        ...
        {
          foreach ($this->statsObj as $iter297)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem303 = null;
              $elem303 = new \metastore\FieldSchema();
              $xfer += $elem303->read($input);
              $this->fieldSchemas []= $elem303;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->fieldSchemas !== null) {
      ...
      $xfer += $output->writeFieldBegin('fieldSchemas', TType::LST, 1);
      {
        ...
        {
          foreach ($this->fieldSchemas as $iter311)
          {
    ...
    if ($this->properties !== null) {
      ...
      $xfer += $output->writeFieldBegin('properties', TType::MAP, 2);
      {
        ...
        {
          foreach ($this->properties as $kiter312 => $viter313)
          {
  ...
  public function write($output) {
    ...
    if ($this->properties !== null) {
      ...
      $xfer += $output->writeFieldBegin('properties', TType::MAP, 1);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->properties));
        {
          foreach ($this->properties as $kiter321 => $viter322)
          {
...
class PingPong {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('PingPong');
    if ($this->len !== null) {
