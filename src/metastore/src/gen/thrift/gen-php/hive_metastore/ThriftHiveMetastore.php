...
interface metastore_ThriftHiveMetastoreIf extends FacebookServiceIf {
  ...
  public function create_file($node_name, $repnr, $table_name);
  public function close_file($file);
  public function get_file_by_id($fid);
  public function rm_file_logical($file);
  public function restore_file($file);
  public function rm_file_physical($file);
}
...
class metastore_ThriftHiveMetastoreClient extends FacebookServiceClient implements metastore_ThriftHiveMetastoreIf {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_create_table_with_environment_context_args();
    $args->tbl = $tbl;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_create_table_with_environment_context_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_create_table_with_environment_context_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->o1 !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_alter_table_with_environment_context_args();
    $args->dbname = $dbname;
    $args->tbl_name = $tbl_name;
    $args->new_tbl = $new_tbl;
    $args->environment_context = $environment_context;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_alter_table_with_environment_context_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_alter_table_with_environment_context_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->o1 !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_add_partition_with_environment_context_args();
    $args->new_part = $new_part;
    $args->environment_context = $environment_context;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_add_partition_with_environment_context_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_add_partition_with_environment_context_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_alter_partition_with_environment_context_args();
    $args->db_name = $db_name;
    $args->tbl_name = $tbl_name;
    $args->new_part = $new_part;
    $args->environment_context = $environment_context;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_alter_partition_with_environment_context_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_alter_partition_with_environment_context_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->o1 !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_update_table_column_statistics_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_update_table_column_statistics_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_update_table_column_statistics_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_update_partition_column_statistics_args();
    $args->stats_obj = $stats_obj;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_update_partition_column_statistics_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_update_partition_column_statistics_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_get_table_column_statistics_args();
    $args->db_name = $db_name;
    $args->tbl_name = $tbl_name;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_get_table_column_statistics_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_get_table_column_statistics_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_get_partition_column_statistics_args();
    $args->db_name = $db_name;
    $args->tbl_name = $tbl_name;
    $args->part_name = $part_name;
    $args->col_name = $col_name;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_get_partition_column_statistics_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_get_partition_column_statistics_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_delete_partition_column_statistics_args();
    $args->db_name = $db_name;
    $args->tbl_name = $tbl_name;
    $args->part_name = $part_name;
    $args->col_name = $col_name;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_delete_partition_column_statistics_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_delete_partition_column_statistics_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_delete_table_column_statistics_args();
    $args->db_name = $db_name;
    $args->tbl_name = $tbl_name;
    $args->col_name = $col_name;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_delete_table_column_statistics_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_delete_table_column_statistics_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function create_file($node_name, $repnr, $table_name)
  {
    $this->send_create_file($node_name, $repnr, $table_name);
    return $this->recv_create_file();
  }

  public function send_create_file($node_name, $repnr, $table_name)
  {
    $args = new metastore_ThriftHiveMetastore_create_file_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_create_file_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_create_file_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_close_file($file)
  {
    $args = new metastore_ThriftHiveMetastore_close_file_args();
    $args->file = $file;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_close_file_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_close_file_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new metastore_ThriftHiveMetastore_get_file_by_id_args();
    $args->fid = $fid;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_get_file_by_id_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_get_file_by_id_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_rm_file_logical($file)
  {
    $args = new metastore_ThriftHiveMetastore_rm_file_logical_args();
    $args->file = $file;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_rm_file_logical_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_rm_file_logical_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_restore_file($file)
  {
    $args = new metastore_ThriftHiveMetastore_restore_file_args();
    $args->file = $file;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_restore_file_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_restore_file_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_rm_file_physical($file)
  {
    $args = new metastore_ThriftHiveMetastore_rm_file_physical_args();
    $args->file = $file;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'metastore_ThriftHiveMetastore_rm_file_physical_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new metastore_ThriftHiveMetastore_rm_file_physical_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem276 = null;
              $elem276 = new metastore_FieldSchema();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem283 = null;
              $elem283 = new metastore_FieldSchema();
...
class metastore_ThriftHiveMetastore_create_table_with_environment_context_args {
  static $_TSPEC;
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->environment_context = new metastore_EnvironmentContext();
...
class metastore_ThriftHiveMetastore_create_table_with_environment_context_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_alter_table_with_environment_context_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_alter_table_with_environment_context_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_add_partition_with_environment_context_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_add_partition_with_environment_context_result {
  static $_TSPEC;
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem325 = null;
              $elem325 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem367 = null;
              $elem367 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem381 = null;
              $elem381 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem402 = null;
              $elem402 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem423 = null;
              $elem423 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem444 = null;
              $elem444 = new metastore_Partition();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem458 = null;
              $elem458 = new metastore_Partition();
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem465 = null;
              $elem465 = new metastore_Partition();
...
class metastore_ThriftHiveMetastore_alter_partition_with_environment_context_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_alter_partition_with_environment_context_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_update_table_column_statistics_args {
  static $_TSPEC;
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->stats_obj = new metastore_ColumnStatistics();
...
class metastore_ThriftHiveMetastore_update_table_column_statistics_result {
  static $_TSPEC;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        4 => array(
          'var' => 'o4',
          'type' => TType::STRUCT,
          'class' => 'metastore_InvalidInputException',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::STRUCT) {
            $this->o4 = new metastore_InvalidInputException();
            $xfer += $this->o4->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
...
class metastore_ThriftHiveMetastore_update_partition_column_statistics_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_update_partition_column_statistics_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_get_table_column_statistics_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_get_table_column_statistics_result {
  static $_TSPEC;
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new metastore_ColumnStatistics();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->o3 = new metastore_InvalidInputException();
            $xfer += $this->o3->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
        ...
        case 4:
          if ($ftype == TType::STRUCT) {
            $this->o4 = new metastore_InvalidObjectException();
            $xfer += $this->o4->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
...
class metastore_ThriftHiveMetastore_get_partition_column_statistics_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_get_partition_column_statistics_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_delete_partition_column_statistics_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_delete_partition_column_statistics_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_delete_table_column_statistics_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_delete_table_column_statistics_result {
  static $_TSPEC;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem548 = null;
              $elem548 = new metastore_HiveObjectPrivilege();
...
class metastore_ThriftHiveMetastore_create_file_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_create_file_result {
  static $_TSPEC;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'o1',
          'type' => TType::STRUCT,
          'class' => 'metastore_FileOperationException',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new metastore_SFile();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->o1 = new metastore_FileOperationException();
            $xfer += $this->o1->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
...
class metastore_ThriftHiveMetastore_close_file_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_close_file_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_get_file_by_id_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_get_file_by_id_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_rm_file_logical_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_rm_file_logical_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_restore_file_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_restore_file_result {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_rm_file_physical_args {
  static $_TSPEC;
...
class metastore_ThriftHiveMetastore_rm_file_physical_result {
  static $_TSPEC;
