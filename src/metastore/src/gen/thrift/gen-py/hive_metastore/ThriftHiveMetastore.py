      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i374 in xrange(_size370):
            ...
            self.originfid.append(_elem375)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i402 in xrange(_size398):
            ...
            self.originfid.append(_elem403)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i475 in xrange(_size471):
            ...
            self.tbl_names.append(_elem476)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i496 in xrange(_size492):
            _elem497 = Partition()
            _elem497.read(iprot)
            self.new_parts.append(_elem497)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 0:
        if ftype == TType.MAP:
          ...
          for _i775 in xrange(_size771):
            _key776 = iprot.readI64();
            _val777 = SFile()
            _val777.read(iprot)
            self.success[_key776] = _val777
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 1:
