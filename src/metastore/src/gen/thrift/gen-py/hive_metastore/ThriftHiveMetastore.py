      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i395 in xrange(_size391):
            ...
            self.originfid.append(_elem396)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i423 in xrange(_size419):
            ...
            self.originfid.append(_elem424)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i580 in xrange(_size576):
            ...
            self.group_names.append(_elem581)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class get_partitions_ps_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i621 in xrange(_size617):
            ...
            self.group_names.append(_elem622)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter624 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i671 in xrange(_size667):
            _elem672 = Partition()
            _elem672.read(iprot)
            self.new_parts.append(_elem672)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i678 in xrange(_size674):
            ...
            self.part_vals.append(_elem679)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter695,viter696 in self.success.items():
        oprot.writeString(kiter695)
        oprot.writeString(viter696)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.o1 is not None:
      oprot.writeFieldBegin('o1', TType.STRUCT, 1)
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i701 in xrange(_size697):
            ...
            self.part_vals[_key702] = _val703
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter704,viter705 in self.part_vals.items():
        oprot.writeString(kiter704)
        oprot.writeString(viter705)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i710 in xrange(_size706):
            ...
            self.part_vals[_key711] = _val712
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter713,viter714 in self.part_vals.items():
...
class get_privilege_set_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i768 in xrange(_size764):
            ...
            self.group_names.append(_elem769)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter770 in self.group_names:
...
class set_ugi_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i782 in xrange(_size778):
            ...
            self.group_names.append(_elem783)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter784 in self.group_names:
...
class migrate2_in_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i859 in xrange(_size855):
            _key860 = iprot.readI64();
            _val861 = SFileLocation()
            _val861.read(iprot)
            self.fileMap[_key860] = _val861
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fileMap is not None:
      ...
      for kiter864,viter865 in self.fileMap.items():
        oprot.writeI64(kiter864)
        viter865.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i877 in xrange(_size873):
            ...
            self.partNames.append(_elem878)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i891 in xrange(_size887):
            ...
            self.partNames.append(_elem892)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
