      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i326 in xrange(_size322):
            ...
            self.tbl_names.append(_elem327)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i347 in xrange(_size343):
            _elem348 = Partition()
            _elem348.read(iprot)
            self.new_parts.append(_elem348)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i526 in xrange(_size522):
            ...
            self.part_vals[_key527] = _val528
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter529,viter530 in self.part_vals.items():
...
class set_ugi_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i577 in xrange(_size573):
            ...
            self.group_names.append(_elem578)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter579 in self.group_names:
