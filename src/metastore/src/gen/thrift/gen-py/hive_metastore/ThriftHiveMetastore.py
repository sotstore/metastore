...
class get_type_all_result:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter357,viter358 in self.success.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i391 in xrange(_size387):
            ...
            self.tbl_names.append(_elem392)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i412 in xrange(_size408):
            _elem413 = Partition()
            _elem413.read(iprot)
            self.new_parts.append(_elem413)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i582 in xrange(_size578):
            ...
            self.part_vals[_key583] = _val584
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter585,viter586 in self.part_vals.items():
        oprot.writeString(kiter585)
        oprot.writeString(viter586)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i591 in xrange(_size587):
            ...
            self.part_vals[_key592] = _val593
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter594,viter595 in self.part_vals.items():
        oprot.writeString(kiter594)
        oprot.writeString(viter595)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.eventType is not None:
      oprot.writeFieldBegin('eventType', TType.I32, 4)
