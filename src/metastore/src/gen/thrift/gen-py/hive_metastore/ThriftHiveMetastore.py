...
class Iface(fb303.FacebookService.Iface):
  ...
  def addNodeAssignment(self, node, database):
    """
    Parameters:
     - node
     - database
  ...
  def modifyNodeAssignment(self, node, database):
    """
    Parameters:
     - node
     - database
  ...
  def deleteNodeAssignment(self, node, database):
    """
    Parameters:
     - node
     - database
...
class Client(fb303.FacebookService.Client, Iface):
  ...
  def addNodeAssignment(self, node, database):
    ...
    Parameters:
     ...
     - database
    """
    self.send_addNodeAssignment(node, database)
    return self.recv_addNodeAssignment()

  def send_addNodeAssignment(self, node, database):
  ...
  def modifyNodeAssignment(self, node, database):
    ...
    Parameters:
     ...
     - database
    """
    self.send_modifyNodeAssignment(node, database)
    return self.recv_modifyNodeAssignment()

  def send_modifyNodeAssignment(self, node, database):
    self._oprot.writeMessageBegin('modifyNodeAssignment', TMessageType.CALL, self._seqid)
    args = modifyNodeAssignment_args()
    args.node = node
    args.database = database
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
  ...
  def recv_modifyNodeAssignment(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = modifyNodeAssignment_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.o1 is not None:
      raise result.o1
    raise TApplicationException(TApplicationException.MISSING_RESULT, "modifyNodeAssignment failed: unknown result");
  ...
  def deleteNodeAssignment(self, node, database):
    ...
    Parameters:
     ...
     - database
    """
    self.send_deleteNodeAssignment(node, database)
    return self.recv_deleteNodeAssignment()

  def send_deleteNodeAssignment(self, node, database):
...
class Processor(fb303.FacebookService.Processor, Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["modifyNodeAssignment"] = Processor.process_modifyNodeAssignment
  ...
  def process_addNodeAssignment(self, seqid, iprot, oprot):
    ...
    result = addNodeAssignment_result()
    try:
      result.success = self._handler.addNodeAssignment(args.node, args.database)
    except MetaException as o1:
      result.o1 = o1
  ...
  def process_modifyNodeAssignment(self, seqid, iprot, oprot):
    args = modifyNodeAssignment_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = modifyNodeAssignment_result()
    try:
      result.success = self._handler.modifyNodeAssignment(args.node, args.database)
    except MetaException as o1:
      result.o1 = o1
    oprot.writeMessageBegin("modifyNodeAssignment", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_deleteNodeAssignment(self, seqid, iprot, oprot):
    ...
    result = deleteNodeAssignment_result()
    try:
      result.success = self._handler.deleteNodeAssignment(args.node, args.database)
    except MetaException as o1:
      result.o1 = o1
...
class addNodeAssignment_args:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'database', (Database, Database.thrift_spec), None, ), # 2
  )

  def __init__(self, node=None, database=None,):
    self.node = node
...
class modifyNodeAssignment_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('modifyNodeAssignment_args')
    if self.node is not None:
      oprot.writeFieldBegin('node', TType.STRUCT, 1)
      self.node.write(oprot)
      oprot.writeFieldEnd()
...
class modifyNodeAssignment_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('modifyNodeAssignment_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i566 in xrange(_size562):
            ...
            self.group_names.append(_elem567)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class get_partitions_ps_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i607 in xrange(_size603):
            ...
            self.group_names.append(_elem608)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter610 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i657 in xrange(_size653):
            _elem658 = Partition()
            _elem658.read(iprot)
            self.new_parts.append(_elem658)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i664 in xrange(_size660):
            ...
            self.part_vals.append(_elem665)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
...
class partition_name_to_spec_result:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter681,viter682 in self.success.items():
        oprot.writeString(kiter681)
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i687 in xrange(_size683):
            ...
            self.part_vals[_key688] = _val689
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter690,viter691 in self.part_vals.items():
        oprot.writeString(kiter690)
        oprot.writeString(viter691)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i696 in xrange(_size692):
            ...
            self.part_vals[_key697] = _val698
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter699,viter700 in self.part_vals.items():
        oprot.writeString(kiter699)
        oprot.writeString(viter700)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.eventType is not None:
      oprot.writeFieldBegin('eventType', TType.I32, 4)
...
class migrate_in_result:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter799,viter800 in self.success.items():
        oprot.writeI64(kiter799)
        viter800.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.o1 is not None:
      oprot.writeFieldBegin('o1', TType.STRUCT, 1)
...
class migrate2_in_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i817 in xrange(_size813):
            ...
            _val819 = SFileLocation()
            _val819.read(iprot)
            self.fileMap[_key818] = _val819
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fileMap is not None:
      ...
      for kiter822,viter823 in self.fileMap.items():
        oprot.writeI64(kiter822)
        viter823.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
