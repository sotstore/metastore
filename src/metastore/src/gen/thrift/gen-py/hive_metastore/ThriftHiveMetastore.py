      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i405 in xrange(_size401):
            ...
            self.tbl_names.append(_elem406)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i426 in xrange(_size422):
            _elem427 = Partition()
            _elem427.read(iprot)
            self.new_parts.append(_elem427)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i460 in xrange(_size456):
            ...
            self.group_names.append(_elem461)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
