...
class set_ugi_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i754 in xrange(_size750):
            ...
            self.group_names.append(_elem755)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter756 in self.group_names:
...
class migrate2_in_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i824 in xrange(_size820):
            ...
            _val826 = SFileLocation()
            _val826.read(iprot)
            self.fileMap[_key825] = _val826
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fileMap is not None:
      ...
      for kiter829,viter830 in self.fileMap.items():
        oprot.writeI64(kiter829)
        viter830.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i842 in xrange(_size838):
            ...
            self.partNames.append(_elem843)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
