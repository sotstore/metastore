      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i461 in xrange(_size457):
            ...
            self.tbl_names.append(_elem462)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i482 in xrange(_size478):
            _elem483 = Partition()
            _elem483.read(iprot)
            self.new_parts.append(_elem483)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i516 in xrange(_size512):
            ...
            self.group_names.append(_elem517)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i531 in xrange(_size527):
            ...
            self.group_names.append(_elem532)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i572 in xrange(_size568):
            ...
            self.group_names.append(_elem573)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i622 in xrange(_size618):
            _elem623 = Partition()
            _elem623.read(iprot)
            self.new_parts.append(_elem623)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class migrate_in_result:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter764,viter765 in self.success.items():
        oprot.writeI64(kiter764)
        viter765.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.o1 is not None:
      oprot.writeFieldBegin('o1', TType.STRUCT, 1)
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i770 in xrange(_size766):
            ...
            self.partNames.append(_elem771)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
