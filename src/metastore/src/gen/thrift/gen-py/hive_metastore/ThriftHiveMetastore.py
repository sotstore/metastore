      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i347 in xrange(_size343):
            ...
            self.part_vals.append(_elem348)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i367 in xrange(_size363):
            ...
            self.originfid.append(_elem368)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i468 in xrange(_size464):
            ...
            self.tbl_names.append(_elem469)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i489 in xrange(_size485):
            _elem490 = Partition()
            _elem490.read(iprot)
            self.new_parts.append(_elem490)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i659 in xrange(_size655):
            ...
            self.part_vals[_key660] = _val661
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter662,viter663 in self.part_vals.items():
        oprot.writeString(kiter662)
        oprot.writeString(viter663)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i668 in xrange(_size664):
            ...
            self.part_vals[_key669] = _val670
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter671,viter672 in self.part_vals.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i777 in xrange(_size773):
            ...
            self.partNames.append(_elem778)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
