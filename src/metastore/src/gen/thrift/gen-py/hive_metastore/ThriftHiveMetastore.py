...
class migrate2_in_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i810 in xrange(_size806):
            ...
            _val812 = SFileLocation()
            _val812.read(iprot)
            self.fileMap[_key811] = _val812
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fileMap is not None:
      ...
      for kiter815,viter816 in self.fileMap.items():
