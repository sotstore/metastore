...
class Subpartition:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter183,viter184 in self.parameters.items():
...
class Partition:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i196 in xrange(_size192):
            ...
            self.parameters[_key197] = _val198
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 8:
        ...
        if ftype == TType.LIST:
          ...
          for _i209 in xrange(_size205):
            _elem210 = Subpartition()
            _elem210.read(iprot)
            self.subpartitions.append(_elem210)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 11:
  ...
  def write(self, oprot):
    ...
    if self.subpartitions is not None:
      ...
      for iter215 in self.subpartitions:
        iter215.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.version is not None:
...
class Table:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i220 in xrange(_size216):
            ...
            _elem221.read(iprot)
            self.partitionKeys.append(_elem221)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.MAP:
          ...
          for _i226 in xrange(_size222):
            ...
            self.parameters[_key227] = _val228
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
  ...
  def write(self, oprot):
    ...
    if self.partitionKeys is not None:
      ...
      for iter235 in self.partitionKeys:
        iter235.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter236,viter237 in self.parameters.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i250 in xrange(_size246):
            _elem251 = SFileLocation()
            _elem251.read(iprot)
            self.locations.append(_elem251)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
...
class Index:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i257 in xrange(_size253):
            ...
            self.parameters[_key258] = _val259
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      oprot.writeFieldBegin('parameters', TType.MAP, 9)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter260,viter261 in self.parameters.items():
