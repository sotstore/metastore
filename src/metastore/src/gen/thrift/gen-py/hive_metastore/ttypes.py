...
class Partition:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i187 in xrange(_size183):
            _elem188 = Subpartition()
            _elem188.read(iprot)
            self.subpartitions.append(_elem188)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
  ...
  def write(self, oprot):
    ...
    if self.subpartitions is not None:
      ...
      for iter192 in self.subpartitions:
        iter192.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.version is not None:
...
class Table:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i197 in xrange(_size193):
            _elem198 = FieldSchema()
            _elem198.read(iprot)
            self.partitionKeys.append(_elem198)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        ...
        if ftype == TType.LIST:
          ...
          for _i210 in xrange(_size206):
            _elem211 = Partition()
            _elem211.read(iprot)
            self.partitions.append(_elem211)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionKeys is not None:
      ...
      for iter212 in self.partitionKeys:
        iter212.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter213,viter214 in self.parameters.items():
        oprot.writeString(kiter213)
        oprot.writeString(viter214)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    ...
    if self.partitions is not None:
      ...
      for iter215 in self.partitions:
        iter215.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i227 in xrange(_size223):
            _elem228 = SFileLocation()
            _elem228.read(iprot)
            self.locations.append(_elem228)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Schema:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i250 in xrange(_size246):
            _elem251 = FieldSchema()
            _elem251.read(iprot)
            self.fieldSchemas.append(_elem251)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
          ...
          for _i256 in xrange(_size252):
            ...
            self.properties[_key257] = _val258
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fieldSchemas is not None:
      ...
      for iter259 in self.fieldSchemas:
        iter259.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.properties is not None:
      ...
      for kiter260,viter261 in self.properties.items():
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i266 in xrange(_size262):
            ...
            self.properties[_key267] = _val268
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
