...
-- Alter PARTITIONS table and constraint
alter table PARTITIONS add (
   PARENT_PART_ID_OID number,
   PARTITION_LEVEL number not null,
   VERSION number not null,
   SUB_PARTITIONS_PART_ID_OID number,
   SUB_PARTITIONS_INTEGER_IDX number
);
