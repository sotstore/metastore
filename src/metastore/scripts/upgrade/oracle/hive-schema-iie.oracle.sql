------------------------------------------------------------------
-- DataNucleus SchemaTool (version 2.0.3) ran at 13/06/2013 16:32:49
------------------------------------------------------------------
...
-- Table DB_PRIVS for classes [org.apache.hadoop.hive.model.MDBPrivilege]
...
-- Table GLOBAL_PRIVS for classes [org.apache.hadoop.hive.model.MGlobalPrivilege]
...
-- Table BUSITPE_COL for classes [org.apache.hadoop.hive.model.MBusiTypeColumn]
CREATE TABLE BUSITPE_COL
(
    BC_ID NUMBER NOT NULL,
    BUSI_TYPE VARCHAR2(128) NULL,
    FCOMMENT VARCHAR2(4000) NULL,
    FNAME VARCHAR2(128) NULL,
    FTYPE VARCHAR2(4000) NOT NULL,
    TBL_ID NUMBER NULL
);

ALTER TABLE BUSITPE_COL ADD CONSTRAINT BUSITPE_COL_PK PRIMARY KEY (BC_ID);
...
-- Table TBL_PRIVS for classes [org.apache.hadoop.hive.model.MTablePrivilege]
...
-- Table PARTITION_INDEX_STORE for classes [org.apache.hadoop.hive.model.MPartitionIndexStore]
...
-- Table NODES for classes [org.apache.hadoop.hive.model.MNode]
CREATE TABLE NODES
(
...
-- Table PARTITIONS for classes [org.apache.hadoop.hive.model.MPartition]
...
-- Table FILE_LOCATION for classes [org.apache.hadoop.hive.model.MFileLocation]
...
-- Table CDS for classes [org.apache.hadoop.hive.model.MColumnDescriptor]
CREATE TABLE CDS
(
    CD_ID NUMBER NOT NULL
);
...
-- Table TBL_COL_PRIVS for classes [org.apache.hadoop.hive.model.MTableColumnPrivilege]
...
-- Table PART_COL_STATS for classes [org.apache.hadoop.hive.model.MPartitionColumnStatistics]
...
-- Table IDXS for classes [org.apache.hadoop.hive.model.MIndex]
CREATE TABLE IDXS
(
...
-- Table SKEWED_STRING_LIST for classes [org.apache.hadoop.hive.model.MStringList]
...
-- Table DBS for classes [org.apache.hadoop.hive.model.MDatabase]
CREATE TABLE DBS
(
    DB_ID NUMBER NOT NULL,
    DC_ID NUMBER NULL,
...
-- Table PART_COL_PRIVS for classes [org.apache.hadoop.hive.model.MPartitionColumnPrivilege]
...
-- Table SDS for classes [org.apache.hadoop.hive.model.MStorageDescriptor]
CREATE TABLE SDS
(
    SD_ID NUMBER NOT NULL,
    CD_ID NUMBER NULL,
...
-- Table PART_PRIVS for classes [org.apache.hadoop.hive.model.MPartitionPrivilege]
...
-- Table DEVICES for classes [org.apache.hadoop.hive.model.MDevice]
...
-- Table SERDES for classes [org.apache.hadoop.hive.model.MSerDeInfo]
CREATE TABLE SERDES
(
    SERDE_ID NUMBER NOT NULL,
    "NAME" VARCHAR2(128) NULL,
...
-- Table FILES for classes [org.apache.hadoop.hive.model.MFile]
CREATE TABLE FILES
(
...
-- Table DCS for classes [org.apache.hadoop.hive.model.MDatacenter]
CREATE TABLE DCS
(
    DC_ID NUMBER NOT NULL,
    "DESC" VARCHAR2(4000) NULL,
...
-- Table PARTITION_EVENTS for classes [org.apache.hadoop.hive.model.MPartitionEvent]
...
-- Table TBLS for classes [org.apache.hadoop.hive.model.MTable]
CREATE TABLE TBLS
(
    TBL_ID NUMBER NOT NULL,
    CREATE_TIME NUMBER (10) NOT NULL,
...
-- Table ROLES for classes [org.apache.hadoop.hive.model.MRole]
CREATE TABLE ROLES
(
...
-- Table TYPES for classes [org.apache.hadoop.hive.model.MType]
CREATE TABLE TYPES
(
...
-- Table TAB_COL_STATS for classes [org.apache.hadoop.hive.model.MTableColumnStatistics]
...
-- Table PARTITION_INDEX for classes [org.apache.hadoop.hive.model.MPartitionIndex]
...
-- Table ROLE_MAP for classes [org.apache.hadoop.hive.model.MRoleMap]
...
-- Constraints for table DB_PRIVS for class(es) [org.apache.hadoop.hive.model.MDBPrivilege]
...
-- Constraints for table GLOBAL_PRIVS for class(es) [org.apache.hadoop.hive.model.MGlobalPrivilege]
...
-- Constraints for table BUSITPE_COL for class(es) [org.apache.hadoop.hive.model.MBusiTypeColumn]
ALTER TABLE BUSITPE_COL ADD CONSTRAINT BUSITPE_COL_FK1 FOREIGN KEY (TBL_ID) REFERENCES TBLS (TBL_ID) INITIALLY DEFERRED ;

CREATE INDEX BUSITPE_COL_N49 ON BUSITPE_COL (TBL_ID);
...
-- Constraints for table TBL_PRIVS for class(es) [org.apache.hadoop.hive.model.MTablePrivilege]
...
-- Constraints for table PARTITION_INDEX_STORE for class(es) [org.apache.hadoop.hive.model.MPartitionIndexStore]
...
-- Constraints for table NODES for class(es) [org.apache.hadoop.hive.model.MNode]
CREATE UNIQUE INDEX UNIQUENODE ON NODES (NODE_ID,NODE_NAME);


-- Constraints for table PARTITIONS for class(es) [org.apache.hadoop.hive.model.MPartition]
ALTER TABLE PARTITIONS ADD CONSTRAINT PARTITIONS_FK3 FOREIGN KEY (TBL_ID) REFERENCES TBLS (TBL_ID) INITIALLY DEFERRED ;
...
CREATE INDEX PARTITIONS_N51 ON PARTITIONS (PARENT_PART_ID_OID);
...
-- Constraints for table FILE_LOCATION for class(es) [org.apache.hadoop.hive.model.MFileLocation]
...
CREATE INDEX FILE_LOCATION_N50 ON FILE_LOCATION (FILE_ID);

CREATE INDEX FILE_LOCATION_N49 ON FILE_LOCATION (NODE_ID);
...
-- Constraints for table CDS for class(es) [org.apache.hadoop.hive.model.MColumnDescriptor]
...
-- Constraints for table TBL_COL_PRIVS for class(es) [org.apache.hadoop.hive.model.MTableColumnPrivilege]
...
-- Constraints for table PART_COL_STATS for class(es) [org.apache.hadoop.hive.model.MPartitionColumnStatistics]
...
-- Constraints for table IDXS for class(es) [org.apache.hadoop.hive.model.MIndex]
...
ALTER TABLE IDXS ADD CONSTRAINT IDXS_FK3 FOREIGN KEY (ORIG_TBL_ID) REFERENCES TBLS (TBL_ID) INITIALLY DEFERRED ;
...
-- Constraints for table SKEWED_STRING_LIST for class(es) [org.apache.hadoop.hive.model.MStringList]
...
-- Constraints for table DBS for class(es) [org.apache.hadoop.hive.model.MDatabase]
...
-- Constraints for table PART_COL_PRIVS for class(es) [org.apache.hadoop.hive.model.MPartitionColumnPrivilege]
...
-- Constraints for table SDS for class(es) [org.apache.hadoop.hive.model.MStorageDescriptor]
...
-- Constraints for table PART_PRIVS for class(es) [org.apache.hadoop.hive.model.MPartitionPrivilege]
...
-- Constraints for table DEVICES for class(es) [org.apache.hadoop.hive.model.MDevice]
...
-- Constraints for table SERDES for class(es) [org.apache.hadoop.hive.model.MSerDeInfo]

-- Constraints for table FILES for class(es) [org.apache.hadoop.hive.model.MFile]
CREATE UNIQUE INDEX UNIQUEFILE ON FILES (FILE_ID,FID);


-- Constraints for table DCS for class(es) [org.apache.hadoop.hive.model.MDatacenter]
CREATE UNIQUE INDEX UNIQUEDATACENTER ON DCS ("NAME");


-- Constraints for table PARTITION_EVENTS for class(es) [org.apache.hadoop.hive.model.MPartitionEvent]
CREATE INDEX PARTITIONEVENTINDEX ON PARTITION_EVENTS (PARTITION_NAME);


-- Constraints for table TBLS for class(es) [org.apache.hadoop.hive.model.MTable]
...
-- Constraints for table ROLES for class(es) [org.apache.hadoop.hive.model.MRole]
CREATE UNIQUE INDEX ROLEENTITYINDEX ON ROLES (ROLE_NAME);


-- Constraints for table TYPES for class(es) [org.apache.hadoop.hive.model.MType]
CREATE UNIQUE INDEX UNIQUETYPE ON TYPES (TYPE_NAME);


-- Constraints for table TAB_COL_STATS for class(es) [org.apache.hadoop.hive.model.MTableColumnStatistics]
...
-- Constraints for table PARTITION_INDEX for class(es) [org.apache.hadoop.hive.model.MPartitionIndex]
...
CREATE INDEX PARTITION_INDEX_N50 ON PARTITION_INDEX (PART_ID);

CREATE INDEX PARTITION_INDEX_N49 ON PARTITION_INDEX (INDEX_ID);
...
-- Constraints for table ROLE_MAP for class(es) [org.apache.hadoop.hive.model.MRoleMap]
...
CREATE TABLE BUSI_TYPES
(
    BUSI_TYPE_ID NUMBER NOT NULL,
    "NAME" VARCHAR2(128) NULL,
    "COMMENT" VARCHAR2(4000) NULL
);

ALTER TABLE BUSI_TYPES ADD CONSTRAINT BUSI_TYPES_PK PRIMARY KEY (BUSI_TYPE_ID);

CREATE UNIQUE INDEX UNIQUEBUSITYPE ON BUSI_TYPES ("NAME");
