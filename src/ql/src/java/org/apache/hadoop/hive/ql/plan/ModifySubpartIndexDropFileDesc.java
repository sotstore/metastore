 ...
 */
public class ModifySubpartIndexDropFileDesc extends DDLDesc implements Serializable {
   ...
   */
  public ModifySubpartIndexDropFileDesc() {
  }
   ...
   */
  public ModifySubpartIndexDropFileDesc(String dbName, String tableName,String indexName,  String partitionName,
      List<Long> fids) {
