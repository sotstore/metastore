 ...
 */
public class ModifyPartIndexDropFileDesc extends DDLDesc implements Serializable {
   ...
   */
  public ModifyPartIndexDropFileDesc() {
  }
   ...
   */
  public ModifyPartIndexDropFileDesc(String dbName, String tableName,String indexName, String partitionName,
      List<Long> fids) {
