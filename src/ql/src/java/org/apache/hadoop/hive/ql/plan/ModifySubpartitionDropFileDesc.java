 ...
 */
public class ModifySubpartitionDropFileDesc extends DDLDesc implements Serializable {
   ...
   */
  public ModifySubpartitionDropFileDesc() {
  }
   ...
   */
  public ModifySubpartitionDropFileDesc(String dbName, String tableName, String partitionName,
      List<Long> fids) {
