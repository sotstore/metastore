 ...
 */
public class ModifyPartitionDropFileDesc extends DDLDesc implements Serializable {
   ...
   */
  public ModifyPartitionDropFileDesc() {
  }
   ...
   */
  public ModifyPartitionDropFileDesc(String dbName, String tableName, String partitionName,
      List<Long> fids) {
