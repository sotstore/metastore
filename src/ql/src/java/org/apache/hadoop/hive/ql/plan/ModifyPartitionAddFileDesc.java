 ...
 */
public class ModifyPartitionAddFileDesc extends DDLDesc implements Serializable {
   ...
   */
  public ModifyPartitionAddFileDesc() {
  }
   ...
   */
  public ModifyPartitionAddFileDesc(String dbName, String tableName, String partitionName,
      List<Long> fids) {
