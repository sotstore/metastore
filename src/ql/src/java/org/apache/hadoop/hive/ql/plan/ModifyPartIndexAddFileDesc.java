 ...
 */
public class ModifyPartIndexAddFileDesc extends DDLDesc implements Serializable {
   ...
   */
  public ModifyPartIndexAddFileDesc() {
  }
   ...
   */
  public ModifyPartIndexAddFileDesc(String dbName, String tableName, String indexName, String partitionName,
      List<Long> fids) {
