 ...
 */
public class ModifySubpartIndexAddFileDesc extends DDLDesc implements Serializable {
   ...
   */
  public ModifySubpartIndexAddFileDesc() {
  }
   ...
   */
  public ModifySubpartIndexAddFileDesc(String dbName, String tableName,String indexName, String partitionName,
      List<Long> fids) {
