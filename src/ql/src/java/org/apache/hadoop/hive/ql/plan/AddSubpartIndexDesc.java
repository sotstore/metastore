 ...
 */
public class AddSubpartIndexDesc extends DDLDesc implements Serializable {
   ...
   * @param indexName
   */
  public AddSubpartIndexDesc(String dbName, String tableName,
